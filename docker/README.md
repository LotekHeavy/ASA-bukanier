...
Dieses Repository enthält eine umfassende Anleitung, um **ARK: Survival Ascended** Server auf **Linux** mithilfe eines Docker-Images zu hosten. Diese Dokumentation basiert auf dem Original von [mschnitzer](https://github.com/mschnitzer/ark-survival-ascended-linux-container-image), wurde jedoch angepasst und erweitert, um spezifische Anforderungen unseres Setups zu berücksichtigen. Zukünftig können weitere Änderungen vorgenommen werden.



## Empfehlung Server Hardware
Hier meine Empfehlung für einen Server mit ein paar wenigen Karten

* CPU: AMD Ryzen™ 9 7950X3D (16 Cores)
* RAM: 128 GB DDR5 ECC
* Harddisk: 2 x 1.92 TB NVMe SSD
* Link zu Hetzner: https://www.hetzner.com/de/dedicated-rootserver/ax102


# Documentation
Source:
https://github.com/mschnitzer/ark-survival-ascended-linux-container-image/edit/main/README.md
